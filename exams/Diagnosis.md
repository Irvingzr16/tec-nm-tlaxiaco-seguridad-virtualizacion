...
|---------------------|------------|------------|
| Irving Zárate Reyes | 22/08/2024 | 20620166   |
...
__El router se encarga de distribuir y administrar la red, comúnmente estas conexiones son inalámbricas, mientras que el swich se encarga de distribuir de una entrada a diversas salidas y comúnmente son alámbrico.__
...
__En base a una práctica que diseñamos el semestre pasado deduzco mi respuesta, no puedo justificarla ),:__

Pregunta Abierta:<br>
Describe las diferencias clave entre TCP y UDP en términos de fiabilidad y uso.<br>
__TCP es orientado a fiabilidad, y garatiza la entrega de datos. mientras que UDP es orientado a eficiencia y velocidad.__
...
windows tiene una buena interfaz de usuario y compatibilidad, mientras que linux es libre, seguro, y requiere conocimientos avanzados.
